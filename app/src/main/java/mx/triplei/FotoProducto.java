...
public class FotoProducto extends Activity {
    ...
    public boolean onOptionsItemSelected(MenuItem item) {
        ...
        Object selectItemProducto= spinProducto.getSelectedItem(); 
        switch (item.getItemId()) {
           ...
           case R.id.action_foto:
                ...
                currentProducto = (mx.smartteam.entities.Producto) selectItemProducto;
                if(currentProducto !=null){
                    i = new Intent(FotoProducto.this, CameraActivity.class);
                    i.putExtra("usuario", currentUsuario);
                    i.putExtra("proyecto", currentProyecto);
                    i.putExtra("pop", currentPop);
                    i.putExtra("tpoFoto", currentFormulario.toString());                    
                    ...
                    i.putExtra("opcionfoto",9);/* Foto Producto */
                    startActivity(i); 
                    finish();
                }else{
                    Toast.makeText(context, "Favor de validar", Toast.LENGTH_LONG).show();
